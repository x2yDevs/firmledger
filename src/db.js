...
/* Durable per-endpoint aggregates power the developer usage dashboard without
   retaining a request-by-request log or putting credentials/URLs in analytics. */
...
/* Webhook subscriptions and their durable delivery queue. Secrets are encrypted
   at rest by src/lib/webhooks.js and are never returned after creation. */
...
/* Existing keys pre-date scopes. The migration below gives them the full
   compatibility set; newly generated keys can be narrowed in the console. */
