...
| Leads inbox | Visitors contact any claimed business from its profile (no account needed) → instant in-app + email ping to the owner → lead worked new → contacted → qualified → won/lost with notes. **Receiving is free; reading/managing needs Pro** — customers are never blocked from reaching a business |
